...
<<<<<<< HEAD
                optionsBuilder.UseMySql("server=192.168.10.155;user=Admin;database=qlbh", x => x.ServerVersion("10.4.14-mariadb"));
=======
                optionsBuilder.UseMySql("server=192.168.10.240;database=qlbh;user=root", x => x.ServerVersion("10.4.14-mariadb"));
>>>>>>> origin/thinh
            }
        }
